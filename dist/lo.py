...
#создаем спрайты
packman = Player('ship.png', 5, win_height - 80, 5)
monster = Enemy('alien.png', win_width - 80, 200, 5)
final_sprite = GameSprite('bullet.png', win_width - 85, win_height - 100, 0)
